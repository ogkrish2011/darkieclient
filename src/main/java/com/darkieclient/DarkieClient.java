...
import com.darkieclient.gui.ClickGuiScreen;
import com.darkieclient.gui.HudEditorScreen;
import com.darkieclient.gui.ModernClickGuiScreen;
import com.darkieclient.input.KeybindHandler;
import com.darkieclient.network.KnockbackDelayBuffer;
...
@Mod(modid = DarkieClient.MOD_ID, name = DarkieClient.NAME, version = DarkieClient.VERSION, clientSideOnly = true)
public final class DarkieClient {
    public static final String MOD_ID = "darkieclient";
    public static final String NAME = "Darkie Client";
    public static final String VERSION = "1.1.0";

    private static DarkieClient instance;
    ...
    public static DarkieClient getInstance() {
        return instance;
    }
